...
\begin{enumerate}
\item Der Verein führt den Namen TechAachen e.V..
...
\item Zweck des Vereins ist
\begin{enumerate}
\item die Förderung von Wissenschaft und Forschung
\item die Förderung der Erziehung, Volks- und Berufsbildung einschließlich der Studentenhilfe;
\end{enumerate}
...
\item die Beschaffung von Mitteln und deren Weiterleitung zur Förderung der steuerbegünstigten Zwecke im Sinne des Absatzes 1 und 2;
...
\item Durchführung und Förderung von Informationsveranstaltungen und Bildungsveranstaltungen;
\item Schaffung einer Plattform für das Umsetzen gemeinnütziger Projekte im Sinne des Absatzes 1 und 2;
\end{enumerate}
...
\begin{enumerate}
\item Körperschaften, die einen des gemeinnützigen Zwecks gemäß Paragraf 52 AO verfolgen; Diese Mitglieder werden reguläre Mitglieder genannt und haben ein Stimmrecht.
...
\item Eine Austrittserklärung aufgrund einer Satzungsänderung oder einer Mehrbelastung durch eine geänderte Beitragsordnung ist durch eine schriftliche Erklärung an den Vorstand zu richten.
...
\begin{enumerate}
\item dem/der 1. und 2. Vorsitzenden
\item dem/der Kassierer/in
\item und ggf. weiteren Vorstandsmitgliedern
\end{enumerate}
...
\item Teammitglieder können unter Erklärung Ihres Einverständnisses durch die Mitgliederversammlung, den Vorstand und das Team selbst berufen werden.   
...
\item Mitglieder von Teams können sowohl durch Beschluss der Mitgliederversammlung, des Vorstandes oder des Teams abberufen werden.
...
\item Die Kassenprüfer/innen dürfen nicht Angehörige desselben Mitglieds wie der/die Kassenführer sein.

\item Wiederwahl ist zulässig.

\item Soll der Vorstand entlastet werden ist der Mitgliederversammlung eine Wochen vor deren Zusammentreten ein Kassenprüfbericht vorzulegen.
...
\item Bei Auflösung oder Aufhebung des Vereins oder bei Wegfall steuerbegünstigter Zwecke fällt das Vermögen des Vereins zu gleichen Teilen den regulären Mitgliedern gemäß §7.1 des Vereines, die es unmittelbar und ausschließlich für gemeinnützige Zwecke zu verwenden haben.
